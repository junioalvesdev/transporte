...
Esse projeto é uma reescrita completa de um sistema de gestão de transporte
de uma organização sem fins lucrativos. O sistema antigo era em PHP; esse
...
No dia a dia, um funcionário que precisa de um transporte abre o
