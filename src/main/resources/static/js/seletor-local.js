/**
 * Componente de "origem"/"destino": um select nativo com as unidades da OVG
 * (igual ao sistema legado) mais uma opcao "Outro Endereco" no fim — ao
...
async function montarSeletorLocal(prefixo, rotulo, elementoContainer) {
    ...
    elementoContainer.innerHTML = `
        ...
        <div data-bloco="outro" class="d-none">
            <button type="button" class="btn btn-link btn-sm p-0 mb-1" data-campo="voltar">&larr; Escolher unidade da OVG</button>
