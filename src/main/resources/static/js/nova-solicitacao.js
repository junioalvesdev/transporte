/**
 * Modal "Nova solicitacao" / "Criar Reservas", na pagina do calendario —
 * acessivel de qualquer aba sem precisar navegar pra outra pagina. Formulario
 * padrao, igual pra qualquer usuario.
 */
...
async function enviarSolicitacao(evento) {
    ...
    try {
        ...
        // se veio da tela de calendario, atualiza ela tambem pra reserva
        // aparecer na hora, sem precisar recarregar a pagina
